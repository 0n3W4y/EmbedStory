...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SampleProject", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SampleProject", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "32";
		app.meta["company"] = "HellGames Studio";
		app.meta["file"] = "SampleProject";
		app.meta["name"] = "EmbedStory";
		app.meta["packageName"] = "com.sample.sampleproject";
